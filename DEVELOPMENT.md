...
The `v0.0.1`, `v0.0.2` and `v0.0.3` tags are immutable public alpha snapshots.
`v0.0.3` is the current stable release; later work remains on `develop` until
another release is explicitly approved.
